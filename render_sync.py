    ...
    SYNC_TABLES = [
        ...
        },
        {
            ...
            'columns': ['code',
                        ...
                        'chk_inv_days_avg','chk_inv_days_high','chk_ar_days_avg','chk_ar_days_high',
            ...
            'create_sql': """CREATE TABLE IF NOT EXISTS stock_checklist (
                ...
                chk_inv_days_avg INTEGER, chk_inv_days_high INTEGER, chk_ar_days_avg INTEGER, chk_ar_days_high INTEGER,
