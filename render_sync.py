    ...
    SYNC_TABLES = [
        ...
        },
        {
            ...
            'columns': ['code',
                        ...
                        'chk_8','chk_9','chk_10','chk_11','chk_12','chk_13',
                        'chk_roic_avg5','chk_roic_latest','chk_roic_3v5','chk_roic_min5',
                        'chk_gm_avg5','chk_gm_latest','chk_gm_3v5','chk_gm_min5',
                        'chk_opm_avg5','chk_opm_latest','chk_opm_3v5','chk_opm_min5',
                        'chk_debt_ratio_ok','chk_fin_debt_ok','chk_icr_ok','chk_icr_min5',
                        'chk_fcf_5y_pos','chk_fcf_latest_pos','chk_eq_ok','chk_eq_min5',
                        'chk_inv_days_avg','chk_inv_days_high','chk_ar_days_avg','chk_ar_days_high','chk_qinv_4v20',
                        'chk_shen_pe_ok','chk_shen_vs_avg5','chk_shen_vs_avg3','chk_eps_5y_pos','chk_eps_5y_stable','chk_core_ratio','chk_shen_yld_ok',
                        ...
                        'chk_payout_ok','chk_shiller_safe','chk_growth_green',
                        'chk_opm_stable','chk_best_aa','chk_roic_trend',
                        'chk_gm_trend','chk_fcf_trend','chk_fcf_cover_div',
            ...
            'create_sql': """CREATE TABLE IF NOT EXISTS stock_checklist (
                ...
                chk_9 INTEGER, chk_10 INTEGER, chk_11 INTEGER, chk_12 INTEGER, chk_13 INTEGER,
                chk_roic_avg5 INTEGER, chk_roic_latest INTEGER, chk_roic_3v5 INTEGER, chk_roic_min5 INTEGER,
                chk_gm_avg5 INTEGER, chk_gm_latest INTEGER, chk_gm_3v5 INTEGER, chk_gm_min5 INTEGER,
                chk_opm_avg5 INTEGER, chk_opm_latest INTEGER, chk_opm_3v5 INTEGER, chk_opm_min5 INTEGER,
                chk_debt_ratio_ok INTEGER, chk_fin_debt_ok INTEGER, chk_icr_ok INTEGER, chk_icr_min5 INTEGER,
                chk_fcf_5y_pos INTEGER, chk_fcf_latest_pos INTEGER, chk_eq_ok INTEGER, chk_eq_min5 INTEGER,
                chk_inv_days_avg INTEGER, chk_inv_days_high INTEGER, chk_ar_days_avg INTEGER, chk_ar_days_high INTEGER, chk_qinv_4v20 INTEGER,
                chk_shen_pe_ok INTEGER, chk_shen_vs_avg5 INTEGER, chk_shen_vs_avg3 INTEGER, chk_eps_5y_pos INTEGER, chk_eps_5y_stable INTEGER, chk_core_ratio INTEGER, chk_shen_yld_ok INTEGER,
                ...
                chk_payout_ok INTEGER, chk_shiller_safe INTEGER, chk_growth_green INTEGER,
                chk_opm_stable INTEGER, chk_best_aa INTEGER, chk_roic_trend INTEGER,
                chk_gm_trend INTEGER, chk_fcf_trend INTEGER, chk_fcf_cover_div INTEGER,
                chk_neff_growth INTEGER, chk_neff_ratio INTEGER,
                chk_lynch_peg INTEGER, chk_lynch_consist INTEGER,
                pass_count INTEGER, total_count INTEGER, profit_count INTEGER, safety_count INTEGER, value_count INTEGER,
