    ...
    SYNC_TABLES = [
        ...
        },
        {
            ...
            'columns': ['code',
                        ...
                        'chk_shen_pe_ok','chk_shen_vs_avg5','chk_shen_vs_avg3','chk_eps_5y_pos','chk_eps_5y_stable','chk_core_ratio',
            ...
            'create_sql': """CREATE TABLE IF NOT EXISTS stock_checklist (
                ...
                chk_shen_pe_ok INTEGER, chk_shen_vs_avg5 INTEGER, chk_shen_vs_avg3 INTEGER, chk_eps_5y_pos INTEGER, chk_eps_5y_stable INTEGER, chk_core_ratio INTEGER,
